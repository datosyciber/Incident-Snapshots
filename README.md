# Threat Hunting Snapshots & MITRE ATT&CK Mapping 
...
- Document incidents using **standardized, repeatable formats**
- Provide **KQL queries** for threat hunting and detection
- Offer **intelligence snapshots** summarizing attacker activity
- Facilitate learning and practice for SOC, DFIR, and CTI workflows
